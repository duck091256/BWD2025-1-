    ...
    return (
        <div className="home-container">
            <div className="trang1">
                ...
                <div className="noidungtrang1">{t('home.introduction')}</div>
                <div className="nut-trang1">
                    <a className="nut-goiy" href="diadiem.html">{t('home.hintBtn')}</a>
                    <a className="nut-dangnhap" href="dangnhap.html">{t('home.loginBtn')}</a>
                </div>
                <div className="container-img">
                    <div className="o1">
                        <img className="imgo1" src={imgo1} alt="" />
                    </div>
                    <div className="o2">
                        <img className="imgo2" src={imgo2} alt="" />
                    </div>
                </div>
            </div>

            <div className="trang2">
                <img className="background-trang2" src={imgbackgroundtrang2} alt="" />
            ...
            <div className="trang3">
                <img className="background-trang3" src={imgbackgroundtrang2} alt="" />
            ...
            <div className="trang4">
                <img className="background-trang4" src={imgbackgroundtrang2} alt="" />
                <div className="anhnen4"></div>
                <img className="imgtrang4 slide-up" src={imgcuatrang4} alt="" />
                <div className="khungchu" style={{ position: 'relative' }}>
                ...
                <span className="muiten muiten-1 slide-left">↓</span>
                <span className="muiten muiten-2 slide-left">↓</span>
            </div>

            <div className="trangcuoi">
                <img className="imgtrangcuoi" src={imgtrangcuoi} alt="" />

                <div className="link-container">
                    <a href="trangchu.html">Trang Chủ</a>
                    <a href="gioithieu.html">Giới Thiệu</a>
                    <a href="diadiem.html">Địa Điểm</a>
                    <a href="sanpham.html">Sản Phẩn</a>
                    <a href="bangtin.html">Bảng Tin</a>
                    <a href="chat.html">Chat</a>
                    <a href="dangnhap.html">Đăng Nhập</a>
                </div>

                <div className="chutrangcuoi">
                    <p>Liên hệ:</p>
                    <p>khoald.24it@vku.udn.vn</p>
                    <p>duclh.24it@vku.udn.vn</p>
                    <p>ductt.24it@vku.udn.vn</p>
                    <p>baonhq.24it@vku.udn.vn</p>
                </div>
